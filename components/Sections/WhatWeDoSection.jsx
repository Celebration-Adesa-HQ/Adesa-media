...
export function WhatWeDoSection() {
  ...
  return (
    <section className="min-h-screen w-full bg-[#0B1121] text-white z-0 overflow-hidden relative font-sans selection:bg-red-500/30">
      ...
      {/* Background Gradient */}
      <div className="absolute top-0 left-0 w-full h-full bg-linear-to-br from-[#0f172a] via-[#0B1121] to-[#050810] z-0" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-200 h-200 bg-blue-900/10 rounded-full blur-3xl z-0 pointer-events-none" />
              ...
              <ol className="space-y-2 font-montserrat text-sm md:text-base text-gray-300">
                {strategy.map((item, i) => (
                  <li key={i} className="flex gap-3">
                    <span className="text-[#ef4444] font-bold min-w-5">
                      {i + 1}.
                    </span>
            ...
            <div className="relative">
              ...
              <ol className="space-y-2 font-montserrat text-sm md:text-base text-gray-300 pl-9">
                {marketing.map((item, i) => (
                  <li key={i} className="flex gap-3">
                    <span className="text-[#14b8a6] font-bold min-w-5">
                      {i + 1}.
                    </span>
                    <span className="leading-tight">{item}</span>
                  </li>
            ...
            <div className="relative mt-4">
              ...
              <ol className="space-y-2 font-montserrat text-sm md:text-base text-gray-300 pl-9">
                {production.map((item, i) => (
                  <li key={i} className="flex gap-3">
                    <span className="text-[#eab308] font-bold min-w-5">
                      {i + 1}.
                    </span>
                    <span className="leading-tight">{item}</span>
                  </li>
