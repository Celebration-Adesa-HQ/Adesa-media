      ...
      <main className="relative z-20 flex flex-1 items-center px-6 sm:px-12 lg:px-20 py-12">
        <div className="max-w-4xl">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#ffa205]/15 border border-[#ffa205]/30 backdrop-blur-md mb-6"
          >
            <Sparkles className="w-3.5 h-3.5 text-[#ffa205]" />
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-amber-300">
              {subheading || "ADESA MEDIA AGENCY"}
            </span>
          </motion.div>
